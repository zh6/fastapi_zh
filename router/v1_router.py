...
from api.v1.sys_module import router as sys_module_router
...
api_v1_router.include_router(sys_module_router, tags=["模块管理"],  dependencies=[Depends(check_jwt_token)])
